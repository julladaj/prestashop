		...
		{if $ps_stock_management}			
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="delivery_now_{$default_language|escape:'htmlall'}">
					...
					<span class="label-tooltip" data-toggle="tooltip"
						title="{l s='Forbidden characters:'} &#60;&#62;;&#61;#&#123;&#125;">
						{l s='Displayed delivery time text when in-stock'}
					</span>
				</label>
				<div class="col-lg-9">
					{include file="controllers/products/input_text_lang.tpl"
						languages=$languages
						input_value=$product->delivery_now
						input_name='delivery_now'}
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-lg-3" for="delivery_later_{$default_language|escape:'htmlall'}">
					...
					<span class="label-tooltip" data-toggle="tooltip"
						title="{l s='Forbidden characters:'} &#60;&#62;;&#61;#&#123;&#125;">
						{l s='Displayed delivery time text when backordering is allowed'}
					</span>
				...
				<div class="col-lg-9">
					{include file="controllers/products/input_text_lang.tpl"
						languages=$languages
						input_value=$product->delivery_later
						input_name='delivery_later'}
				</div>
			</div>
