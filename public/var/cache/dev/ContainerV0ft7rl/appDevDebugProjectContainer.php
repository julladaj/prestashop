...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lRT3R94mUu', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G8U3o0Z5ch', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'wein_dev', 'user' => 'wein_dev', 'password' => '&5g33qhtzgXkhUVo', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('nnpctx5el1'))) && false ?: '_'});
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('nnpctx5el1');
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LtO9GF1Y06', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U9hRr2SgJv', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eboggqtE1I', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('G+nCacxL49S3hBMGbsNbuL4pgWtHLDbAxo0l0tQPSiJRfafitCr8KxX+imMqaBzz'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('G+nCacxL49S3hBMGbsNbuL4pgWtHLDbAxo0l0tQPSiJRfafitCr8KxX+imMqaBzz');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                0 => ($this->targetDirs[3].'/modules/socialsharing/translations'),
                1 => ($this->targetDirs[3].'/modules/dashactivity/translations'),
                2 => ($this->targetDirs[3].'/modules/dashtrends/translations'),
                3 => ($this->targetDirs[3].'/modules/dashgoals/translations'),
                4 => ($this->targetDirs[3].'/modules/dashproducts/translations'),
                5 => ($this->targetDirs[3].'/modules/graphnvd3/translations'),
                6 => ($this->targetDirs[3].'/modules/gridhtml/translations'),
                7 => ($this->targetDirs[3].'/modules/homefeatured/translations'),
                8 => ($this->targetDirs[3].'/modules/pagesnotfound/translations'),
                9 => ($this->targetDirs[3].'/modules/sekeywords/translations'),
                10 => ($this->targetDirs[3].'/modules/statsbestcategories/translations'),
                11 => ($this->targetDirs[3].'/modules/statsbestcustomers/translations'),
                12 => ($this->targetDirs[3].'/modules/statsbestproducts/translations'),
                13 => ($this->targetDirs[3].'/modules/statsbestsuppliers/translations'),
                14 => ($this->targetDirs[3].'/modules/statsbestvouchers/translations'),
                15 => ($this->targetDirs[3].'/modules/statscarrier/translations'),
                16 => ($this->targetDirs[3].'/modules/statscatalog/translations'),
                17 => ($this->targetDirs[3].'/modules/statscheckup/translations'),
                18 => ($this->targetDirs[3].'/modules/statsdata/translations'),
                19 => ($this->targetDirs[3].'/modules/statsequipment/translations'),
                20 => ($this->targetDirs[3].'/modules/statsforecast/translations'),
                21 => ($this->targetDirs[3].'/modules/statslive/translations'),
                22 => ($this->targetDirs[3].'/modules/statsnewsletter/translations'),
                23 => ($this->targetDirs[3].'/modules/statsorigin/translations'),
                24 => ($this->targetDirs[3].'/modules/statspersonalinfos/translations'),
                25 => ($this->targetDirs[3].'/modules/statsproduct/translations'),
                26 => ($this->targetDirs[3].'/modules/statsregistrations/translations'),
                27 => ($this->targetDirs[3].'/modules/statssales/translations'),
                28 => ($this->targetDirs[3].'/modules/statssearch/translations'),
                29 => ($this->targetDirs[3].'/modules/statsstock/translations'),
                30 => ($this->targetDirs[3].'/modules/statsvisits/translations'),
                31 => ($this->targetDirs[3].'/modules/productcomments/translations'),
                32 => ($this->targetDirs[3].'/modules/oneandonehosting/translations'),
                33 => ($this->targetDirs[3].'/modules/autoupgrade/translations'),
                34 => ($this->targetDirs[3].'/modules/productscategory/translations'),
                35 => ($this->targetDirs[3].'/modules/dateofdelivery/translations'),
                36 => ($this->targetDirs[3].'/modules/pscleaner/translations'),
                37 => ($this->targetDirs[3].'/modules/ps_linklist/translations'),
                38 => ($this->targetDirs[3].'/modules/blockreassurance/translations'),
                39 => ($this->targetDirs[3].'/modules/ps_contactinfo/translations'),
                40 => ($this->targetDirs[3].'/modules/ps_languageselector/translations'),
                41 => ($this->targetDirs[3].'/modules/ps_currencyselector/translations'),
                42 => ($this->targetDirs[3].'/modules/ps_customersignin/translations'),
                43 => ($this->targetDirs[3].'/modules/ps_shoppingcart/translations'),
                44 => ($this->targetDirs[3].'/modules/ps_mainmenu/translations'),
                45 => ($this->targetDirs[3].'/modules/ps_searchbar/translations'),
                46 => ($this->targetDirs[3].'/modules/ps_imageslider/translations'),
                47 => ($this->targetDirs[3].'/modules/ps_featuredproducts/translations'),
                48 => ($this->targetDirs[3].'/modules/ps_banner/translations'),
                49 => ($this->targetDirs[3].'/modules/ps_customtext/translations'),
                50 => ($this->targetDirs[3].'/modules/ps_emailsubscription/translations'),
                51 => ($this->targetDirs[3].'/modules/ps_socialfollow/translations'),
                52 => ($this->targetDirs[3].'/modules/ps_customeraccountlinks/translations'),
                53 => ($this->targetDirs[3].'/modules/ps_categorytree/translations'),
                54 => ($this->targetDirs[3].'/modules/ps_emailalerts/translations'),
                55 => ($this->targetDirs[3].'/modules/ps_cashondelivery/translations'),
                56 => ($this->targetDirs[3].'/modules/cookielaw/translations'),
                57 => ($this->targetDirs[3].'/modules/ps_crossselling/translations'),
                ...
                60 => ($this->targetDirs[3].'/modules/managepostcode/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                11 => 'pagesnotfound',
                12 => 'sekeywords',
                13 => 'statsbestcategories',
                14 => 'statsbestcustomers',
                15 => 'statsbestproducts',
                16 => 'statsbestsuppliers',
                ...
                45 => 'pscleaner',
                46 => 'securitypatch',
                47 => 'advancedeucompliance',
                48 => 'cashondelivery',
                49 => 'ps_linklist',
                50 => 'blockreassurance',
                51 => 'ps_contactinfo',
                52 => 'ps_languageselector',
                53 => 'ps_currencyselector',
                54 => 'ps_customersignin',
                55 => 'ps_shoppingcart',
                56 => 'ps_mainmenu',
                57 => 'ps_searchbar',
                58 => 'ps_imageslider',
                59 => 'ps_featuredproducts',
                60 => 'ps_banner',
                61 => 'ps_customtext',
                62 => 'ps_emailsubscription',
                63 => 'ps_socialfollow',
            ...
            'kernel.secret' => 'G+nCacxL49S3hBMGbsNbuL4pgWtHLDbAxo0l0tQPSiJRfafitCr8KxX+imMqaBzz',
