...
<div class="tabs">
    <form>
        <div class="js-mailalert" style="text-align:center;" data-url="{url entity='module' name='ps_emailalerts' controller='actions' params=['process' => 'add']}">
            ...
            <button class="btn btn-primary btn-block" type="submit" rel="nofollow" onclick="return addNotification();">{l s='Notify me when available' d='Modules.Mailalerts.Shop'}</button>
            <p style="padding:5px 0">{l s='*) if available again' d='Modules.Mailalerts.Shop'}</p>
        </div>
    </form>
</div>
